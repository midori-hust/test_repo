...
void compileProgram(void) {
  ...
  //  prog->progAttrs->codeAddress = getCurrentCodeAddress();
...
ConstantValue* compileConstant2(void) {
  ...
  case TK_IDENT:
    eat(TK_IDENT);
    temp = lookupObject(currentToken->string); // Tim xem bien da duoc khai bao chua
