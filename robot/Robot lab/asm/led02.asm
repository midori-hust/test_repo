...
;;;;;;;;;;;;;;;;;;;;;;（5）LED点滅開始;;;;;;;;;;;;;;;;;;;;;;;;;
LED:	
        MOVLW   B'00001000'     ;PORTBに(B5,B4,B3)=(0,0,1)を出力
        MOVWF   PORTB           ;左のLEDを1つ点灯
	...
	CALL	WAIT
        MOVLW   B'00010000'     ;PORTBに(B5,B4,B3)=(0,1,0)を出力
        MOVWF   PORTB           ;真中のLEDを1つ点灯
	...
	CALL	WAIT
        MOVLW   B'00100000'     ;PORTBに(B5,B4,B3)=(1,0,0)を出力
        MOVWF   PORTB           ;右のLEDを1つ点灯
