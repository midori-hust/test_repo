...
//
// Please modify the corresponding derived classes in ./src/frame1.cc
...
frame1_glade::frame1_glade(GlademmData *gmm_data
)
{  frame1 = this;
   flabel1 = Gtk::manage(new class Gtk::Label(_("")));
   ...
   flabel1->set_selectable(false);
   frame1->set_size_request(320,320);
